...
Thanks for using anylr! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/JamesHWade/anylr/issues/new).
...
requests](https://github.com/JamesHWade/anylr/issues) to make sure the
