# Tutorial: Getting Started with measure
...
![](tutorial-getting-started_files/figure-html/raw-spectra-1.png)
...
![](tutorial-getting-started_files/figure-html/processed-spectra-1.png)
...
- **[Mendeley Data](https://data.mendeley.com)** - Search for
  spectroscopy/chromatography datasets
- **[Zenodo](https://zenodo.org)** - Open science data repository
- **[NIST Chemistry WebBook](https://webbook.nist.gov/chemistry/)** -
  Reference IR, MS, UV-Vis spectra
- **[MassBank](https://massbank.eu/MassBank/)** - Mass spectrometry
  database
