...
`step_measure_align_ptw()` creates a *specification* of a recipe step
that aligns spectra using Parametric Time Warping (PTW). This method
uses polynomial warping functions to correct for shifts and distortions.
