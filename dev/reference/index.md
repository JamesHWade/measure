...
Registration and discovery for peak detection algorithms
...
- [`has_peak_algorithm()`](https://jameshwade.github.io/measure/dev/reference/has_peak_algorithm.md)
...
- [`unregister_peak_algorithm()`](https://jameshwade.github.io/measure/dev/reference/unregister_peak_algorithm.md)
  : Unregister a Peak Detection Algorithm

## Peak Model Classes

S3 class architecture for peak shape models used in deconvolution

- [`new_peak_model()`](https://jameshwade.github.io/measure/dev/reference/new_peak_model.md)
  : Create a Peak Model Object
- [`is_peak_model()`](https://jameshwade.github.io/measure/dev/reference/is_peak_model.md)
...
- [`has_peak_model()`](https://jameshwade.github.io/measure/dev/reference/has_peak_model.md)
...
- [`unregister_peak_model()`](https://jameshwade.github.io/measure/dev/reference/unregister_peak_model.md)
...
- [`peak_model_area()`](https://jameshwade.github.io/measure/dev/reference/peak_model_area.md)
  : Calculate Peak Area
- [`peak_model_param_names()`](https://jameshwade.github.io/measure/dev/reference/peak_model_param_names.md)
  : Get Parameter Names from Peak Model
- [`validate_peak_model_params()`](https://jameshwade.github.io/measure/dev/reference/validate_peak_model_params.md)
  : Validate Peak Model Parameters
- [`sum_peak_models()`](https://jameshwade.github.io/measure/dev/reference/sum_peak_models.md)
  : Sum Multiple Peak Models

## Built-in Peak Models

Core peak shape models for deconvolution
...
Support for 2D and higher-dimensional measurement data (LC-DAD, EEM, 2D
NMR)
...
- [`measure_dim_names()`](https://jameshwade.github.io/measure/dev/reference/measure_dim_names.md)
  : Get dimension names of an n-dimensional measurement
- [`measure_dim_units()`](https://jameshwade.github.io/measure/dev/reference/measure_dim_units.md)
  : Get dimension units of an n-dimensional measurement
- [`measure_is_regular()`](https://jameshwade.github.io/measure/dev/reference/measure_is_regular.md)
...
- [`find_measure_nd_cols()`](https://jameshwade.github.io/measure/dev/reference/find_measure_nd_cols.md)
  : Find n-dimensional measure columns in a data frame
- [`get_measure_col_ndim()`](https://jameshwade.github.io/measure/dev/reference/get_measure_col_ndim.md)
