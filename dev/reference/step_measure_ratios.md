...
#> # A tibble: 215 × 6
#>       id water   fat protein .measures low_high_ratio
#>    <int> <dbl> <dbl>   <dbl>    <meas>          <dbl>
#>  1     1  60.5  22.5    16.7 [100 × 2]          0.824
#>  2     2  46    40.1    13.5 [100 × 2]          0.839
#>  3     3  71     8.4    20.5 [100 × 2]          0.896
#>  4     4  72.8   5.9    20.7 [100 × 2]          0.882
#>  5     5  58.3  25.5    15.5 [100 × 2]          0.800
#>  6     6  44    42.7    13.7 [100 × 2]          0.829
#>  7     7  44    42.7    13.7 [100 × 2]          0.841
#>  8     8  69.3  10.6    19.3 [100 × 2]          0.821
#>  9     9  61.4  19.9    17.7 [100 × 2]          0.824
#> 10    10  61.4  19.9    17.7 [100 × 2]          0.828
#> # ℹ 205 more rows
```
