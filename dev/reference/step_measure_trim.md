...
#>  1     1  60.5  22.5    16.7  [81 × 2] <int [100]>
#>  2     2  46    40.1    13.5  [81 × 2] <int [100]>
#>  3     3  71     8.4    20.5  [81 × 2] <int [100]>
#>  4     4  72.8   5.9    20.7  [81 × 2] <int [100]>
#>  5     5  58.3  25.5    15.5  [81 × 2] <int [100]>
#>  6     6  44    42.7    13.7  [81 × 2] <int [100]>
#>  7     7  44    42.7    13.7  [81 × 2] <int [100]>
#>  8     8  69.3  10.6    19.3  [81 × 2] <int [100]>
#>  9     9  61.4  19.9    17.7  [81 × 2] <int [100]>
#> 10    10  61.4  19.9    17.7  [81 × 2] <int [100]>
#> # ℹ 205 more rows
```
