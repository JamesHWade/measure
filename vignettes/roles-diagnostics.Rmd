...
For analytical chemistry workflows, you might want to identify special sample types:
...
```{r check-interactive, eval=FALSE}
...
4
. **Visualize at each stage** - use `autoplot()` to verify preprocessing effects
