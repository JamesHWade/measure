---
title: "Integrating with tidymodels"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Integrating with tidymodels}
...
measure's Savitzky-Golay step has tunable parameters. Let's find the optimal window size and differentiation order:
...
- Tune Savitzky-Golay parameters with `tune_grid()`
